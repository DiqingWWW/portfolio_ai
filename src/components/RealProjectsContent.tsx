...
export default function RealProjectsContent({ heading, intro, projects, labels }: { heading: string; intro: string; projects: ProjectData[]; labels: { selectedRealWork: string; viewProject: string } }) {
  return (
    <div className="space-y-5 select-text" data-component="RealProjectsContent">
      <header className="border-b border-neutral-100 pb-4">
        <p className="font-mono text-[9px] font-bold uppercase tracking-[0.16em] text-sky-600">{labels.selectedRealWork}</p>
