...
// The V1 homepage: the original macOS-workspace composition (floating windows, project
// folder, workspace chips). V2 replaced it at / and /zh, so this module is what keeps V1
// reachable for review and rollback at /proto/v1-home and /zh/proto/v1-home.
// It must live outside src/app/page.tsx: Next 16 typed routes reject extra exports
// from a page module (TS2344 via .next/dev/types/app/page.ts).
