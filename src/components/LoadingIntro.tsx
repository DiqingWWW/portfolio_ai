...
const MESSAGE = "I know the UI looks rough, but I'm having a hard time dealing with AI slop, so please be patient with me...";
...
export default function LoadingIntro() {
  ...
  useEffect(() => {
    ...
    return () => window.clearTimeout(exitTimer);
  }, [isVisible, prefersReducedMotion, visibleCharacters]);
